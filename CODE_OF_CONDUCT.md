...
1. **Correction**: A private or public request to stop the behavior.
2. **Warning**: A formal warning with consequences for continued behavior.
3. **Temporary Ban**: Temporary removal from interaction.
4. **Permanent Ban**: Permanent removal from interaction.
